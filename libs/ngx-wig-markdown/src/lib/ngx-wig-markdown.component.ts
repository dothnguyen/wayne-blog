...
/** @dynamic */
@Component({
  selector: 'ngx-wig-markdown',
  templateUrl: './ngx-wig-markdown.component.html',
  styleUrls: ['./ngx-wig-markdown.component.css'],
  providers: [
    NgxWigMardownToolbarService,
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => NgxWigMarkdownComponent),
      multi: true
    }
  ],
  encapsulation: ViewEncapsulation.None
})
export class NgxWigMarkdownComponent implements AfterViewInit,
                                        OnInit,
                                        OnChanges,
                                        OnDestroy,
  ...
  public constructor(
    private _ngWigToolbarService: NgxWigMardownToolbarService,
